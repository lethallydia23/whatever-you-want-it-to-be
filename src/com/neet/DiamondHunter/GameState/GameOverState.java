...
public class GameOverState extends GameState 
{
	...
	public void draw(Graphics2D g) 
	{
		...
		switch(rank)
		{
		case 1: Content.drawString(g, "speed demon", 20, 78);
			break;
		case 2: Content.drawString(g, "adventurer", 24, 78);
			break;
		case 3: Content.drawString(g, "beginner", 32, 78);
			break;
		case 4: Content.drawString(g, "bumbling idiot", 8, 78);
			break;
		}
